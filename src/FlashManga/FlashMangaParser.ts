...
import { FLASH_MANGA_DOMAIN, cleanUrl, parseChapterNumber, parseThaiDate } from './FlashMangaHelper'

export class FlashMangaParser {
    ...
    static parseMangaTiles($: any): MangaTile[] {
        ...
        items.each((_: any, element: any) => {
            ...
            // Image handling (supports standard src, data-src, and lazy-loading)
